...
import natalieImg from "@/assets/team/Natalie_Hume.jpg";
import ninaImg from "@/assets/team/17c1aae4-3c65-444b-aab3-f9a67a7f6406.jpeg.webp";
import caitlinImg from "@/assets/team/7912af3f-7cee-44c8-8f09-0594f2fa7337.jpeg.webp";
import placeholderImg from "@/assets/team/image.jpg";
import emilyImg from "@/assets/team/EC.jpeg";
import essyImg from "@/assets/team/EP.jpeg";
import libbyImg from "@/assets/team/LM.jpeg";
import hollyImg from "@/assets/team/HD.jpeg";
import georgiaImg from "@/assets/team/GM.jpeg";
...
const team = [
  ...
  { name: "Danielle McPeake", role: "Student Teacher", image: placeholderImg },
  { name: "Emily Carson", role: "Student Teacher", image: emilyImg },
  { name: "Essy Purslow", role: "Student Teacher", image: essyImg },
  { name: "Connie Maguire", role: "Student Teacher", image: placeholderImg },
  { name: "Libby Mcmillan", role: "Student Teacher", image: libbyImg },
  { name: "Holly Durban", role: "Student Teacher", image: hollyImg },
  { name: "Elizabeth Peskir", role: "Student Teacher", image: placeholderImg },
  { name: "Georgia McGlone", role: "Student Teacher", image: georgiaImg },
];
